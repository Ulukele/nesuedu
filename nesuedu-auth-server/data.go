...
func (dbe *DBEngine) CreateUser(username string, password string, firstName string, lastName string) (*UserModel, error) {
	user := &UserModel{Username: username, Password: password, FirstName: firstName, LastName: lastName}
